...
DEMO_SCANS = [
    {
        ...
        "full_analysis": {
            ...
            "health_status": "Sehat",
            "treatment_steps": [
                "Pertahankan jadwal penyiraman 2x seminggu",
                "Aplikasi pupuk NPK seimbang setiap 2 bulan",
                "Pangkas daun tua untuk merangsang pertumbuhan baru",
            ],
    ...
    },
    {
        ...
        "full_analysis": {
            ...
            "health_status": "Sakit - Bercak Daun Bakteri",
            "treatment_steps": [
                "Pisahkan tanaman dari tanaman lain untuk mencegah penularan",
                "Potong dan buang daun yang berbercak jauh dari area tanam",
                "Semprot bakarisida berbasis tembaga 1x seminggu hingga membaik",
                "Kurangi frekuensi penyiraman, hindari membasahi daun",
